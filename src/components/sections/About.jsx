      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="w-16 h-1.5 bg-medical-primary rounded-full"></div>
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-md sm:col-span-2 hover:shadow-lg transition-shadow">
              <GraduationCap className="text-medical-primary mb-4" size={36} />
              <h3 className="font-semibold text-slate-900 mb-2 text-xl">Education</h3>
              <p className="text-slate-700 font-medium text-lg">B.S. in Pharmacy</p>
              <p className="text-slate-600">Başkent University | Ankara, Turkey</p>
              <p className="text-sm text-slate-500 mt-2 font-medium bg-slate-100 inline-block px-3 py-1 rounded-full">09/2023 - Present</p>
            </div>
            
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-md sm:col-span-2 hover:shadow-lg transition-shadow">
              <Languages className="text-medical-primary mb-4" size={36} />
              <h3 className="font-semibold text-slate-900 mb-4 text-xl">Languages</h3>
